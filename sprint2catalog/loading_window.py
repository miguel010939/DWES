...
class LoadingWindow:
    def __init__(self, root):
        ...
        self.canvas = tk.Canvas(self.root, width=60, height=60,
                                bg=label_bg_color)  # se instancia un canvas del mismo color de background que el label
        self.canvas.pack()
    ...
    def draw_progress_circle(self, progress):
        ...
        self.canvas.create_arc(10, 10, 35, 35,
                               start=90, extent=angle, tags="progress", outline='teal', width=4,
                               style=tk.ARC)  # start=90 para empezar arriba en lugar de a la derecha
    ...
    def update_progress_circle(self):
        ...
        self.root.after(100,
                        self.update_progress_circle)  # se llama a la funcion update_progress_circle desde ella misma: el circulo se dibuja recursivamente
